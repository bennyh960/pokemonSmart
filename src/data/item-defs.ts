...
export const ITEM_GAME_DATA: Record<number, ItemGameDef> = {
  ...
  9003: {
    ...
    description: { en: 'A classified document dropped by a Team Rocket grunt. Prof. Algorithma needs to analyse it.', he: 'מסמך סודי שנשמט מסוכן של צוות רוקט. פרופ׳ אלגוריתמה צריכה לנתח אותו.' },
    keyFlag: 'key-secret-doc-obtained',
    usedFlag: 'key-secret-doc-analyzed',
    usedDescription: { en: 'Analysed by Prof. Algorithma. The data has been decoded.', he: 'נותח על ידי פרופ׳ אלגוריתמה. הנתונים פוענחו.' },
  },
  9004: {
    category: 'key',
    price: 0,
    ...
    description: { en: 'A fragment of NULL-X\'s core code. One of eight pieces needed to shut it down permanently.', he: 'שבר מקוד הליבה של NULL-X. אחד משמונה חלקים הנדרשים לכיבויו הקבוע.' },
  ...
  9011: {
    ...
    description: { en: 'The final fragment of NULL-X\'s core code. With this, the shutdown sequence can begin.', he: 'השבר האחרון של קוד הליבה של NULL-X. עם זה, רצף הכיבוי יכול להתחיל.' },
    keyFlag: 'key-core-x8-obtained',
    usedFlag: 'key-core-x8-used',
    usedDescription: { en: 'All fragments neutralised. NULL-X has been shut down.', he: 'כל השברים נוטרלו. NULL-X כובה.' },
  },
