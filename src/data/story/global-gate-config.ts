...
export const DEFAULT_SESSION_CONFIG: Omit<GateSessionConfig, 'questionsRequired' | 'timeLimitPerQuestion'> = {
  ...
  penaltyAmount: 100,          // 100 PokeCoins deducted on penalty
...
export const AUTO_GATE_REWARDS: Record<string, GateReward[]> = {
  pokecenter: [{ type: 'money', amount: 500 },{ type: "item", itemId: "45", quantity: 1 },{ type: "item", itemId: "46", quantity: 1 }],
...
export const VERIFICATION_DIALOGUES = {
  pokecenter: [
    { en: 'HALT! Nurse Joy\'s sensors detected a possible NULL-X signature. Please verify your identity to enter.', he: 'עצור! חיישני האחות ג\'וי זיהו חתימה אפשרית של NULL-X. אנא אמת את זהותך כדי להיכנס.' },
    { en: 'This pokecenter is protected. Only verified trainers may enter. Prove you are not a glitch.', he: 'מרכז הפוקימון מוגן. רק מאמנים מאומתים יכולים להיכנס. הוכח שאינך תקלה.' },
    { en: 'Welcome, trainer! Before we heal your pokemon, we must confirm you\'re not a NULL-X infiltrator.', he: 'ברוך הבא, מאמן! לפני שנרפא את הפוקמונים שלך, עלינו לוודא שאינך מסתנן של NULL-X.' },
  ],
  pokemarket: [
    { en: 'Shop clerk: The market security system flagged your approach. Answer these questions to shop freely.', he: 'פקיד החנות: מערכת האבטחה של השוק סימנה את ההתקרבות שלך. ענה על שאלות אלה כדי לקנות בחופשיות.' },
    { en: 'Security alert: NULL-X has been known to drain market funds. Identity check required.', he: 'התראת אבטחה: ידוע כי NULL-X מרוקן כספי שוק. נדרש בדיקת זהות.' },
    { en: 'The pokemart requires verification before large purchases. Please solve these to continue.', he: 'הפוקמרט דורש אימות לפני רכישות גדולות. אנא פתור את אלה כדי להמשיך.' },
  ],
  gym: [
    { en: 'GYM GUARD: This gym has been targeted by NULL-X. Prove your intelligence before you may challenge the leader!', he: 'שומר הGYM: ה-GYM הזה ממוקד על ידי NULL-X. הוכח את האינטליגנציה שלך לפני שתוכל לאתגר את המנהיג!' },
    { en: 'Only real trainers may challenge this gym. NULL-X cannot solve these math puzzles. Can you?', he: 'רק מאמנים אמיתיים יכולים לאתגר את ה-GYM הזה. NULL-X לא יכול לפתור את חידות המתמטיקה האלה. אתה יכול?' },
    { en: 'The gym leader will only battle those who have proven their mind is their own. Take the verification test.', he: 'מנהיג ה-GYM יתמודד רק עם אלה שהוכיחו שדעתם שייכת להם. קח את מבחן האימות.' },
  ],
};
...
registerGate({
  ...
  description: { en: 'Prove you are not NULL-X to access healing services.', he: 'הוכח שאינך NULL-X כדי לגשת לשירותי ריפוי.' },
...
registerGate({
  ...
  description: { en: 'The gym only admits verified, non-glitched trainers.', he: 'ה-GYM מקבל רק מאמנים מאומתים ושאינם תקולים.' },
