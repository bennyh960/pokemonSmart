...
registerCutscene({
  ...
  steps: [
    ...
    },
    {
      ...
      speakerId: 'Prof. Algorithma / פרופ׳ אלגוריתמה',
      lines: [
        { en: "You have a rare gift — an intuition for numbers and logic. I've been waiting for someone like you.", he: ' שמעתי שיש לך כישרון נדיר — אינטואיציה למספרים ולוגיקה. חיכיתי למישהו כמוך.' },
      ],
    },
    {
      type: 'dialogue',
