...
| ~~10~~ | ~~Player loses (last Pokemon faints): trainer renders at top-left corner of screen and can't move. The handleLoss() in battle.ts resets position to (0,0) which is a tree tile. Should teleport player to nearest/last Pokemon Center and heal party instead~~ | ~~high~~ | ~~battle~~ | ~~2026-03-20~~ | ~~game-engine-developer~~ | **closed** |
...
| 1 | Hebrew font barely readable — fixed by resolution refactor (ctx.scale renders fonts at physical resolution) | high | i18n | 2026-03-21 | resolution refactor |
| 3 | Battle move grid too tight for 8 moves — removed, battle scene will be redesigned | high | battle | 2026-03-21 | removed (battle redesign planned) |
